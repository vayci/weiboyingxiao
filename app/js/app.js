...
App.controller("AccountsController",
    ["$scope", "toastr", "$modal", function($scope, toastr, $modal) {
...
App.controller('LogsController',
    ["$scope", "toastr", "$state", function($scope, toastr, $state) {
...
App.controller('AppController', ['$rootScope', '$scope', '$state', '$window', '$localStorage', '$timeout', 'toggleStateService',

    function($rootScope, $scope, $state, $window, $localStorage, $timeout, toggle) {
        "use strict";
...
App.controller('NavigationController', ['$rootScope', '$scope', '$state',
...
App.controller('SettingsController', ['$scope', 'toastr',
